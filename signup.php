        ...
        <!-- Registration Form -->
								<form id="register-form" action="#"  role="form" style="display: none;">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<button onclick="clicked()" name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-register">
                           Register Now
                        </button>
                        <div id="message">
                        </div>
...
<script>
   ...
   function clicked(){
     ...
     $.ajax({
       ...
       url: 'service.php?userName=' + $('#userName').val() + '&password=' + $('#password').val(),
       dataType: "json",
